...
| [`opensubtitles`](providers/opensubtitles_org/) | 0.1.11 | Scrapes OpenSubtitles.org natively with ai-cloudscraper, inline Anubis solving, and optional FlareSolverr fallback for Cloudflare challenges. |
