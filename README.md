...
| [`yavkanet`](providers/yavkanet/) | 0.1.0 | Scrapes [Yavka.net](https://yavka.net) for Bulgarian, English, Russian, Spanish, and Italian subtitles by IMDb id. Uses cloudscraper with optional FlareSolverr fallback. |
