...
| [`opensubtitlescom`](providers/opensubtitlescom/) | 0.1.1 | Uses the official [OpenSubtitles.com](https://www.opensubtitles.com) API for movie and episode subtitles. Requires username, password, and API key. |
