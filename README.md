...
| [`opensubtitles_org`](providers/opensubtitles_org/) | 0.1.0 | Uses the external [OpenSubtitles.org scraper helper](https://github.com/LavX/opensubtitles-scraper) by default, with legacy XML-RPC mode available for compatible deployments. |
...
- `providers/opensubtitles_org/`: uses the OpenSubtitles.org scraper helper by default and keeps XML-RPC mode available.
