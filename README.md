...
| [`subsarr`](providers/subsarr/) | 0.1.0 | Connects to a self-hosted [Subsarr](https://github.com/slimcdk/subsarr) API for Subscene-style movie and episode subtitles. Requires a Base URL. |
