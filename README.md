...
| [`yifysubtitles`](providers/yifysubtitles/) | 0.1.0 | Scrapes [YIFYSubtitles](https://yifysubtitles.ch) for movie subtitles in broad multilingual coverage. No login or API key. |
