...
| [`turkcealtyaziorg`](providers/turkcealtyaziorg/) | 0.1.1 | Scrapes [TurkceAltyazi.org](https://turkcealtyazi.org) by IMDb id for Turkish and English movie and episode subtitles. Uses ai-cloudscraper by default with optional FlareSolverr fallback for Cloudflare challenges. |
