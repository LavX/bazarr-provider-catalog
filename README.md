...
| [`soustitreseu`](providers/soustitreseu/) | 0.1.0 | Scrapes [Sous-Titres.eu](https://www.sous-titres.eu) for French and English movie and episode subtitles. No login or API key. |
