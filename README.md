...
| [`embeddedsubtitles`](providers/embeddedsubtitles/) | 0.1.0 | Extracts subtitle streams embedded in local movie and episode media files with ffprobe and ffmpeg. No login or API key. |
