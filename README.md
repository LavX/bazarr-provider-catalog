...
| [`tvsubtitles`](providers/tvsubtitles/) | 0.1.0 | Scrapes [tvsubtitles.net](https://www.tvsubtitles.net) for episode subtitles in broad multilingual coverage. No login or API key. |
