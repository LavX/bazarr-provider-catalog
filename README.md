...
| [`subs4series`](providers/subs4series/) | 0.1.0 | Scrapes [Subs4Series](https://www.subs4series.com) for Greek and English episode subtitles. Optional captcha helper settings are available for download gates. |
...
- `providers/subs4series/`: scrapes Subs4Series episode subtitles with anti-block requests, optional captcha helper settings, and archive extraction.
