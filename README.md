...
| [`shooter`](providers/shooter/) | 0.1.0 | Queries [Shooter.cn](https://www.shooter.cn) hash-based subtitle API for English and Chinese movie and episode subtitles. No login or API key. |
