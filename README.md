...
| [`avistaz`](providers/avistaz/) | 0.1.1 | Uses [AvistaZ](https://avistaz.to) release pages from Sonarr or Radarr history to download attached subtitles. Requires session cookies. |
...
- `providers/avistaz/`: uses AvistaZ release pages from Sonarr or Radarr history to download attached subtitles.
