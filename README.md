...
| [`yavkanet`](providers/yavkanet/) | 0.1.1 | Scrapes [Yavka.net](https://yavka.net) for Bulgarian, English, Russian, Spanish, and Italian subtitles by IMDb id. Uses ai-cloudscraper with optional FlareSolverr fallback. |
...
- `providers/yavkanet/`: scrapes Yavka.net by IMDb id, including Cloudflare fallback and archive downloads.
