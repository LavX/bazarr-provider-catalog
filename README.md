...
| [`regielive`](providers/regielive/) | 0.1.0 | Uses the RegieLive Bazarr API for Romanian movie and episode subtitles. No login or user API key. |
...
- `providers/regielive/`: uses the RegieLive Bazarr API for Romanian movie and episode subtitles.
