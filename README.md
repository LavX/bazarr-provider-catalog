...
| [`opensubtitles`](providers/opensubtitles_org/) | 0.1.10 | Scrapes OpenSubtitles.org natively with ai-cloudscraper, inline Anubis solving, and optional FlareSolverr fallback for Cloudflare challenges. |
| [`opensubtitlescom`](providers/opensubtitlescom/) | 0.1.7 | Uses the official [OpenSubtitles.com](https://www.opensubtitles.com) API for movie and episode subtitles. Requires username, password, and API key. |
...
| [`titlovi`](providers/titlovi/) | 0.1.7 | Uses the [Titlovi](https://kodi.titlovi.com/api/subtitles) Kodi API for movie and episode subtitles. Login required. |
