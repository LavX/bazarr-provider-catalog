...
class SubtitrariNoiProviderTests(unittest.TestCase):
    ...
    def test_search_returns_requested_movie_variant_and_orders_by_download_count(self):
        ...
        self.assertEqual(results[0]["language"], {"alpha3": "ron", "alpha2": "ro", "hi": True, "forced": False})
    ...
    def test_search_returns_episode_result_for_forced_language_variant(self):
        provider = self.mod.SubtitrariNoiProvider()
        ...
        self.assertEqual(results[0]["language"]["forced"], True)
