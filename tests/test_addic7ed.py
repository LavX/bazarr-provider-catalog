...
class Addic7edSearchTests(unittest.TestCase):
    ...
    def test_episode_search_uses_cookies_and_parses_rows(self):
        ...
        self.assertEqual(results[0]["provider"], "addic7ed_com")
        self.assertEqual(results[0]["provider_payload"]["legacy_provider_id"], "addic7ed")
        self.assertEqual(results[0]["display"]["legacy_provider_id"], "addic7ed")
