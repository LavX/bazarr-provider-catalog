...
- YavkaNet download notice on 2026-06-03: keep YavkaNet marked as source-side download limited. The June 2 site banner says some titles are no longer available for downloads and recommends `bultor.net` or `nanoset.biz`; do not spend more live validation cycles on YavkaNet until a title or session is found where downloads are currently permitted.
