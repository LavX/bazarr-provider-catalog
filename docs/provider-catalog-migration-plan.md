...
- Main-branch catalog inventory: 40 bundles currently ship from `main` after the Gestdown, BSPlayer, Subtis, SubtitulamosTV, TVSubtitles, GreekSubs, AnimeKalesi, AnimeSub.info, OpenSubtitles.org, AnimeTosho, NapiProjekt, SubF2M, Nekur, GreekSubtitles, PrijevodiOnline, Soustitres.eu, Subclub, SubsSabBz, SubsUnacs, SubSynchro, Subs4Free, Subs4Series, Embedded Subtitles, Subtitrari Noi, YIFYSubtitles, Subtitri.id, Titrari, and SuperSubtitles merges.
...
- Merge progress through 2026-06-02 UTC: PR [#75](https://github.com/LavX/bazarr-provider-catalog/pull/75), PR [#15](https://github.com/LavX/bazarr-provider-catalog/pull/15), PR [#17](https://github.com/LavX/bazarr-provider-catalog/pull/17), PR [#18](https://github.com/LavX/bazarr-provider-catalog/pull/18), PR [#20](https://github.com/LavX/bazarr-provider-catalog/pull/20), PR [#19](https://github.com/LavX/bazarr-provider-catalog/pull/19), PR [#21](https://github.com/LavX/bazarr-provider-catalog/pull/21), PR [#22](https://github.com/LavX/bazarr-provider-catalog/pull/22), PR [#23](https://github.com/LavX/bazarr-provider-catalog/pull/23), PR [#14](https://github.com/LavX/bazarr-provider-catalog/pull/14), PR [#16](https://github.com/LavX/bazarr-provider-catalog/pull/16), PR [#24](https://github.com/LavX/bazarr-provider-catalog/pull/24), PR [#25](https://github.com/LavX/bazarr-provider-catalog/pull/25), PR [#26](https://github.com/LavX/bazarr-provider-catalog/pull/26), PR [#31](https://github.com/LavX/bazarr-provider-catalog/pull/31), PR [#30](https://github.com/LavX/bazarr-provider-catalog/pull/30), PR [#32](https://github.com/LavX/bazarr-provider-catalog/pull/32), PR [#33](https://github.com/LavX/bazarr-provider-catalog/pull/33), PR [#34](https://github.com/LavX/bazarr-provider-catalog/pull/34), PR [#35](https://github.com/LavX/bazarr-provider-catalog/pull/35), PR [#36](https://github.com/LavX/bazarr-provider-catalog/pull/36), PR [#37](https://github.com/LavX/bazarr-provider-catalog/pull/37), PR [#67](https://github.com/LavX/bazarr-provider-catalog/pull/67), PR [#54](https://github.com/LavX/bazarr-provider-catalog/pull/54), PR [#38](https://github.com/LavX/bazarr-provider-catalog/pull/38), PR [#43](https://github.com/LavX/bazarr-provider-catalog/pull/43), PR [#39](https://github.com/LavX/bazarr-provider-catalog/pull/39), PR [#41](https://github.com/LavX/bazarr-provider-catalog/pull/41), PR [#40](https://github.com/LavX/bazarr-provider-catalog/pull/40), PR [#13](https://github.com/LavX/bazarr-provider-catalog/pull/13), PR [#68](https://github.com/LavX/bazarr-provider-catalog/pull/68), notes-only PR [#63](https://github.com/LavX/bazarr-provider-catalog/pull/63), notes-only PR [#66](https://github.com/LavX/bazarr-provider-catalog/pull/66), notes-only PR [#73](https://github.com/LavX/bazarr-provider-catalog/pull/73), notes-only PR [#74](https://github.com/LavX/bazarr-provider-catalog/pull/74), follow-up PR [#76](https://github.com/LavX/bazarr-provider-catalog/pull/76), and follow-up PR [#77](https://github.com/LavX/bazarr-provider-catalog/pull/77) were merged after local verification and live PR inspection.
...
- Pull request: [#63](https://github.com/LavX/bazarr-provider-catalog/pull/63), notes-only PR merged on 2026-06-02 UTC at merge commit `ee0a22b7621d12805b4640a413182e865c574b9f`, final head `57de6261c9c660eb004e50322f414b57fe46ad5e`.
- Baseline evidence on 2026-05-31:
  - Fresh worktree baseline `python3 -B -m sdk validate`: `catalog ok`.
  - Fresh worktree baseline `python3 -B -m unittest discover -s tests`: `328` tests passed, `6` skipped.
- Local evidence on 2026-06-01:
...
- Notes-only merge evidence on 2026-06-02:
  - Live review-thread inspection found no review threads on PR `#63`.
  - Live PR diff was scoped to `docs/provider-notes/subscenter.md`.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `12` tests passed with `6` skipped.
  - `rg -n "subscenter|SubsCenter" README.md catalog.json providers tests -S`: no matches, confirming no active catalog provider was shipped.
  - `git diff --check origin/main...HEAD`: clean.
  - Prohibited punctuation and attribution scan over `docs/provider-notes/subscenter.md` found no matches.
  - `gh pr view 63 --repo LavX/bazarr-provider-catalog --json number,state,mergedAt,mergeCommit,headRefOid,url`: PR `#63` is `MERGED`, merge commit `ee0a22b7621d12805b4640a413182e865c574b9f`, final head `57de6261c9c660eb004e50322f414b57fe46ad5e`.
- Remaining gates:
...
- Pull request: [#66](https://github.com/LavX/bazarr-provider-catalog/pull/66), notes-only PR merged on 2026-06-02 UTC at merge commit `b6de689fcef269dd3ac1169a980bcb7e232e76e4`, final head `5a179222d52adfc600cb6fee0df0098b1b446f91`.
- Baseline evidence on 2026-05-31:
  - Fresh worktree baseline `python3 -B -m sdk validate`: `catalog ok`.
  - Fresh worktree baseline `python3 -B -m unittest discover -s tests`: `328` tests passed, `6` skipped.
- Local evidence on 2026-06-01:
...
- Notes-only merge evidence on 2026-06-02:
  - Live review-thread inspection found no review threads on PR `#66`.
  - Live PR diff was scoped to `docs/provider-notes/xsubs.md`.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `12` tests passed with `6` skipped.
  - `rg -n "xsubs|XSubs" README.md catalog.json providers tests -S`: no matches, confirming no active catalog provider was shipped.
  - `git diff --check origin/main...HEAD`: clean.
  - Prohibited punctuation and attribution scan over `docs/provider-notes/xsubs.md` found no matches.
  - `gh pr view 66 --repo LavX/bazarr-provider-catalog --json number,state,mergedAt,mergeCommit,headRefOid,url`: PR `#66` is `MERGED`, merge commit `b6de689fcef269dd3ac1169a980bcb7e232e76e4`, final head `5a179222d52adfc600cb6fee0df0098b1b446f91`.
- Remaining gates:
...
- Current-main merge and final PR evidence on 2026-06-02:
  - Live review-thread inspection found no review threads on PR `#68`.
  - `4f47192` merges current `origin/main` into `catalog-subs4series`, resolving generated `README.md` and `catalog.json` while preserving the Subs4Series provider scope.
  - `python3 -B -m unittest discover -s tests -p 'test_subs4series.py'`: `12` tests passed.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `14` tests passed with `6` skipped.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m sdk runtime-matrix`: Python `3.12`, `3.13`, and `3.14`, ABI tags `cp312`, `cp313`, `cp314`, and `abi3`.
  - `python3 -B -m py_compile providers/subs4series/provider.py`: passed.
  - `git diff --check --cached` and `git diff --check origin/main...HEAD`: clean.
  - Prohibited punctuation and attribution scan across README, catalog, Subs4Series notes, provider code, tests, and fixtures found no matches.
  - `python3 -B -m unittest discover -s tests`: `724` tests passed with `6` skipped.
...
- Embedded Anubis body follow-up on 2026-06-02:
  ...
  - Live PR review-thread inspection found a P2 request to parse Anubis script payloads shaped as `{"rules": ..., "challenge": "..."}` instead of treating the embedded page as normal HTML.
  - Red TDD gate `python3 -B -m unittest discover -s tests -p 'test_subs4series.py' -k string_challenge`: failed because `_extract_anubis_challenge` returned `None` for the string-form challenge.
  - `d390f8d` accepts string-form Anubis challenges, reads difficulty and method from top-level `rules`, guards non-dict challenge payloads, refreshes bundle hashes, and resolves the active review thread.
  - `python3 -B -m unittest discover -s tests -p 'test_subs4series.py' -k string_challenge`: `1` test passed.
  - `python3 -B -m unittest discover -s tests -p 'test_subs4series.py'`: `14` tests passed.
  - `python3 -B -m py_compile providers/subs4series/provider.py`: passed.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `14` tests passed with `6` skipped.
  - `git diff --check` and `git diff --cached --check`: clean.
  ...
  - Live PR review-thread inspection found the PR `#77` thread resolved, and `gh pr checks 77` reported no checks on branch `catalog-subs4series`.
  - `gh pr view 77 --repo LavX/bazarr-provider-catalog --json number,state,mergedAt,mergeCommit,headRefOid,url`: PR `#77` is `MERGED`, merge commit `03a5a4af6126ede49f7e8325100f1b895742c77a`, final head `d390f8d00b2207eb80815feda8c2a9826f2f9c98`.
...
- Native Yunsuo verification evidence on 2026-06-02:
  ...
  - Added current live Zimuku search-page row parsing for inline `/detail/...` subtitle rows and filtered the Dune result from the Planet Dune false positive.
  - Fixed Yunsuo verify URL encoding and `srcurl` cookie source handling.
  - Fixed relative Yunsuo verify URLs to join against the challenged response host, so `zimuku.org` detail and download pages do not verify against `srtku.com`.
  - Increased the Yunsuo verification retry ceiling to tolerate repeated valid challenge rounds.
  - Red TDD gates covered native BMP captcha solving, current live inline search rows, search integration without old `/subs/...` fallback, more than four challenge retries, and host-aware verify URL joining.
  - `python3 -B -m unittest discover -s tests -p 'test_zimuku.py'`: `11` tests passed.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `15` tests passed with `6` skipped.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m py_compile providers/zimuku/provider.py`: passed.
  - `python3 -B -m sdk runtime-matrix`: Python `3.12`, `3.13`, and `3.14`.
  - `git diff --check`: clean.
  - Touched-file attribution and conflict-marker scan across Zimuku files found no matches.
  - `python3 -B -m unittest discover -s tests`: `739` tests passed with `6` skipped.
...
- Current-main refresh on 2026-06-02:
  - `d0f4e5f` merges current `origin/main` into `catalog-wizdom`, resolving generated `README.md` and `catalog.json` conflicts while preserving the Wizdom provider scope.
  - `python3 -B -m unittest discover -s tests -p 'test_wizdom.py'`: `17` tests passed.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `14` tests passed with `6` skipped.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m py_compile providers/wizdom/provider.py`: passed.
...
- Current checkpoint: `e78c47b Pass embedded NapiProjekt Anubis URL`
- PR: `https://github.com/LavX/bazarr-provider-catalog/pull/25` opened on 2026-06-01, head `catalog-napiprojekt`, base `main`, final head `5666c03`, merged on 2026-06-02 UTC at `36af7f4777c64a68c1d1da44b97cd42b6befe8a2`. Follow-up PR `#76` merged on 2026-06-02 UTC at `f941c6b972c0cff11cdb0a03f00197f28ac5ff00`, final head `e78c47b4c0b64b62ca9a7f6c4cd5f615ecd9af59`.
- Baseline evidence on 2026-05-29:
  - Fresh worktree baseline `python3 -B -m sdk validate`: `catalog ok`.
  - Fresh worktree baseline `python3 -B -m unittest discover -s tests`: `328` tests passed, `6` skipped.
- Local evidence on 2026-05-29:
...
- Embedded Anubis body follow-up on 2026-06-02:
  ...
  - Live PR review-thread inspection found a P1 request to pass the embedded `/.within.website/?redir=...` URL to the Anubis solver instead of sending the original POST endpoint.
  - Red TDD gate `python3 -B -m unittest discover -s tests -p 'test_napiprojekt.py' -k anubis_body`: failed because `solve_anubis_challenge` received `https://www.napiprojekt.pl/ajax/search_catalog.php` instead of `https://www.napiprojekt.pl/.within.website/?redir=/ajax/search_catalog.php`.
  - `e78c47b` extracts the embedded Anubis redirect URL from the response body, passes that challenge URL into the solver, refreshes bundle hashes, and makes the original review thread outdated.
  - `python3 -B -m unittest discover -s tests -p 'test_napiprojekt.py' -k anubis_body`: `1` test passed.
  ...
  - Live PR review-thread inspection found the PR `#76` review thread outdated after `e78c47b`, and `gh pr checks 76` reported no checks on branch `catalog-napiprojekt`.
  - `gh pr view 76 --repo LavX/bazarr-provider-catalog --json number,state,mergedAt,mergeCommit,headRefOid,url`: PR `#76` is `MERGED`, merge commit `f941c6b972c0cff11cdb0a03f00197f28ac5ff00`, final head `e78c47b4c0b64b62ca9a7f6c4cd5f615ecd9af59`.
...
- Fresh recheck on 2026-06-02:
  - Fetched current `origin/main`; branch scope remains limited to README, catalog, YavkaNet notes, `providers/yavkanet`, `tests/test_yavkanet.py`, and the YavkaNet fixture.
  - Live GraphQL review-thread inspection found no review threads on PR `#42`; `gh pr view` reported merge state `CLEAN`, and `gh pr checks 42` reported no checks.
  - `python3 -B -m unittest discover -s tests -p 'test_yavkanet.py'`: `15` tests passed.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `14` tests passed with `6` skipped.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m sdk runtime-matrix`: Python `3.12`, `3.13`, and `3.14`.
  - `python3 -B -m py_compile providers/yavkanet/provider.py`: passed.
  - `git diff --check origin/main...HEAD`: clean.
  - Attribution scan across YavkaNet files found no matches.
...
- Current-main refresh on 2026-06-02:
  - `3901e9f` merges current `origin/main` into `catalog-turkcealtyaziorg`, resolving generated `README.md` and `catalog.json` conflicts while preserving the TurkceAltyazi.org provider scope.
  - `python3 -B -m unittest discover -s tests -p 'test_turkcealtyaziorg.py'`: `15` tests passed.
  - `python3 -B -m unittest discover -s tests -p 'test_catalog.py'`: `14` tests passed with `6` skipped.
  - `python3 -B -m sdk validate`: `catalog ok`.
  - `python3 -B -m py_compile providers/turkcealtyaziorg/provider.py`: passed.
